...
class BaiDuPan(object):
    def __init__(self):
        ...
        self.session.cookies['BDUSS'] = '5TbTN5dGp3RGZkc0lsQ2ZhQ2VBaEZIVWFDdkRkS34tdGtSdlQxREs0WHBxbU5oSUFBQUFBJCQAAAAAAAAAAAEAAAA180MvvKHArMWSwYjBh9LYz8YAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAOkdPGHpHTxhU0'
        self.session.cookies['STOKEN'] = 'b9f2ce8dfdee513e84bc42687f3011c61a7a6ce841f99ebda575e1f95350a411'
        self.headers = {
            'Host': 'pan.baidu.com',
    ...
    def saveShare(self, url, pwd=None, path='/'):
        ...
        share_data = json.loads(
            re.search("locals.mset\(({.*})\)", share_page).group(1))
...
#     B = BaiDuPan()
#     B.saveShare('https://pan.baidu.com/s/1HkfYrki_6CpBKc1vkv374Q',pwd='lili')
